...
export const activeMarkets = "Richmond, KY · Elizabethtown, KY · Gardner, KS · Kansas City, KS · Norwalk, IA · Kennewick, WA · Sunnyside, WA";

export const roleOptions = [
  "Individual Investor",
  "Institutional Investor / Family Office",
  "Municipal Official / City Planner",
  "Builder / Contractor",
  "Broker / Placement Agent",
  "Professional Partner / Contractor",
  "Media / Press",
  "Other",
];
